...
"%JAVA_HOME%\bin\java" -Xmx128M -cp "%CLASSPATH%;%CXF_JAR%;%SUN_TOOL_PATH%" -Djava.util.logging.config.file="%CXF_HOME%\etc\logging.properties" org.apache.cxf.tools.wsdlto.WSDLToJava %*
