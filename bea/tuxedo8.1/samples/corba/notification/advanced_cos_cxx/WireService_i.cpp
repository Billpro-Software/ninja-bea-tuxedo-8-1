...
// interfaces for the advanced cos notification c++ sample
//
...
void WireService_i::report_news(const char* category, const char* story)
{
  ...
  try {
    ...
    REPORT("WireService_i::cancel_subscribers failed: " << e);
  }
}
...
void WireService_i::shutdown_subscribers()
{
  ...
  try {
    ...
    REPORT("WireService_i::shutdown_subscribers failed: " << e);
  }
}
