...
static void get_crs_num_lst(
    UniversityS::CourseNumberList& crs_num_lst
)
{
    int done = 0;
    while (!done) {
...
static CORBA::Boolean display_course_synopsis_list(
    const UniversityS::CourseSynopsisList& crs_syn_lst,
...
static void destroy_enumerator(
    UniversityS::CourseSynopsisEnumerator_ptr p_crs_syn_enum
)
{
...
static void get_courses_synopsis(
    UniversityS::Registrar_ptr p_reg_ref,
...
)
{
    ...
    // this object
    UniversityS::CourseSynopsisEnumerator_var v_crs_syn_enum;

    // how many more matching courses are available ?
    CORBA::ULong num_remaining;

    // get the matching courses
    UniversityS::CourseSynopsisList_var v_crs_syn_lst =
...
)
{
    ...
    UniversityS::CourseDetailsList_var v_crs_det_lst =
...
static void list_registered_courses(
    UniversityS::Registrar_ptr p_reg_ref,
    UniversityS::StudentId     stu_id
)
{
    UniversityS::StudentDetails_var v_stu_det =
...
static UniversityS::Registrar_ptr get_registrar(
    Tobj_Bootstrap&        bootstrap
)
{
    ...
    CORBA::Object_var v_reg_fact_oref =
        v_fact_finder_ref->find_one_factory_by_id(
            UniversityS::_tc_RegistrarFactory->id()
        );

    // Narrow the registrar factory :
    UniversityS::RegistrarFactory_var v_reg_fact_ref =
        UniversityS::RegistrarFactory::_narrow(
            v_reg_fact_oref.in()
        );
...
int main(int argc, char* argv[])
{
	...
	CORBA::ORB_var v_orb = CORBA::ORB_init(argc, argv, "");
        ...
        UniversityS::StudentId stu_id =
            UniversityS::StudentId(get_long("Student id"));
        ...
        try {
            UniversityS::Registrar_var v_reg_ref =
