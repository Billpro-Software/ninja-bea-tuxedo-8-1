...
static void get_crs_det(
    Database&                   db,
    UniversityS::CourseNumber   crs_num,
    UniversityS::CourseDetails& crs_det
)
{
...

    {
        ...
        UniversityS::Days days = 0;
        if (sched.get_mon_sched()) { days |= UniversityS::MONDAY;    }
        if (sched.get_tue_sched()) { days |= UniversityS::TUESDAY;   }
        if (sched.get_wed_sched()) { days |= UniversityS::WEDNESDAY; }
        if (sched.get_thu_sched()) { days |= UniversityS::THURSDAY;  }
        if (sched.get_fri_sched()) { days |= UniversityS::FRIDAY;    }
...
UniversityS::CourseSynopsisList*
...
)
{
    ...
    try {
        ...
        UniversityS::CourseSynopsisList_var v_crs_syn_lst =
            new UniversityS::CourseSynopsisList;
...
)
{
    ...
    try {
        ...
        UniversityS::CourseSynopsisEnumerator_var v_rest = 
            UniversityS::CourseSynopsisEnumerator::_narrow(
                rest_oref.in()
            );
        ...
        if (number_remaining == 0) {
            ...
            // a "nil" one
            v_rest->destroy();
            v_rest = UniversityS::CourseSynopsisEnumerator::_nil();
...
)
{
    ...
    try {
        ...
        UniversityS::CourseDetailsList_var v_crs_det_lst =
           new UniversityS::CourseDetailsList();
...
)
{
    ...
    try {
        ...
        UniversityS::StudentDetails_var v_stu_det =
            new UniversityS::StudentDetails();
...
UniversityS::Registrar_ptr RegistrarFactory_i::find_registrar(
)
{
    ...
    try {
        ...
        return UniversityS::Registrar::_narrow(v_reg_oref.in());
    }
    HANDLE_EX
}
