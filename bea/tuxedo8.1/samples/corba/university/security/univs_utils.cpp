...
)
{
    ...
    {
        os << '\t';
        UniversityS::Days days =
            val.class_schedule.class_days;
        if ( days & UniversityS::MONDAY    ) { os << "mon "; }
        if ( days & UniversityS::TUESDAY   ) { os << "tue "; }
        if ( days & UniversityS::WEDNESDAY ) { os << "wed "; }
        if ( days & UniversityS::THURSDAY  ) { os << "thu "; }
        if ( days & UniversityS::FRIDAY    ) { os << "fri "; }
        os << endl;
    }
