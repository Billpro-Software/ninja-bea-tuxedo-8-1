...
public class UnivWApplet extends java.applet.Applet 
{

    UniversityW.CourseSynopsis[] gCourseSynopsis;
    UniversityW.CourseDetails[] gCourseDetailsFromSrvr;
    UniversityW.Registrar gRegistrarObjRef;
    UniversityW.CourseDetails[] gRegisteredCourses;
    UniversityW.StudentDetails gStudentDetails;
            ...
            if (status.value() == org.omg.Security.AuthenticationStatus._SecAuthSuccess)
            {
                ...
                try
                {
                    ...
                    org.omg.CORBA.Object Of =
                        Ff.find_one_factory_by_id(UniversityW.RegistrarFactoryHelper.id());
                    UniversityW.RegistrarFactory F = UniversityW.RegistrarFactoryHelper.narrow(Of);
    ...
    void fillCourseSynopsisList()
    {
        ...
        UniversityW.CourseSynopsis[] course_synopsis =
                                getCourseSynopsisFromServer( search_string);

        UniversityW.CourseDetails[] registered_courses =
     ...
     *
     * @return UniversityW.CourseSynopsis[] An array of UniversityW.CourseSynopsis
     *                      returned by the server.
     *
     */
    UniversityW.CourseSynopsis[] getCourseSynopsisFromServer( String aCriteria)
    {

        UniversityW.CourseSynopsis[] course_synopsis_chunks = null;
        UniversityW.CourseSynopsis[] chunk_course_synopsis_from_server = null;
        final int CHUNK_SIZE = 10;
        int total_fetched = 0;
        int num_to_fetch = 0;

        org.omg.CORBA.IntHolder number_remaining = new org.omg.CORBA.IntHolder();
        UniversityW.CourseSynopsisEnumeratorHolder enumerate_the_rest =
        ...
        try
        {
            ...
            course_synopsis_chunks =
                          new UniversityW.CourseSynopsis[chunk_course_synopsis_from_server.length];
        ...
        try
        {
            ...
            while (num_to_fetch != 0)
            {
                ...
                UniversityW.CourseSynopsis[] temp_course_synopsis_chunks =
                          new UniversityW.CourseSynopsis[new_chunks_length];
                ...
                {
                    temp_course_synopsis_chunks[index] = new UniversityW.CourseSynopsis(
    ...
    void registerSynopsisList()
    {
        ...
        UniversityW.NotRegistered[] not_registered = null;
    ...
    void getCourseDetailsFromServer( int[] aSelectedCourseNumbers)
    {
        ...
        UniversityW.CourseDetails[] chunk_details_from_server = null;

        // Contains all the chunks we've gotten
        UniversityW.CourseDetails[] chunks_in_hand = null;
        ...
        for (int chunk_count = 0; chunk_count < chunks_to_get; chunk_count++)
        {
            ...
            UniversityW.CourseDetails[] temp_details_chunks =
                            new UniversityW.CourseDetails[new_chunks_length];
     ...
     */
    void fillDetailsPanel( UniversityW.CourseDetails aDetailsForCourse)
    {
        ...
        if ((aDetailsForCourse.class_schedule.class_days & UniversityW.MONDAY.value) != 0)
            DetailsInfoMonLabel.setForeground(gPurpleColor);
        else
            DetailsInfoMonLabel.setForeground(gGrayColor);

        if ((aDetailsForCourse.class_schedule.class_days & UniversityW.TUESDAY.value) != 0)
            DetailsInfoTueLabel.setForeground(gPurpleColor);
        else
            DetailsInfoTueLabel.setForeground(gGrayColor);

        if ((aDetailsForCourse.class_schedule.class_days & UniversityW.WEDNESDAY.value) != 0)
            DetailsInfoWedLabel.setForeground(gPurpleColor);
        else
            DetailsInfoWedLabel.setForeground(gGrayColor);

        if ((aDetailsForCourse.class_schedule.class_days & UniversityW.THURSDAY.value) != 0)
            DetailsInfoThuLabel.setForeground(gPurpleColor);
        else
            DetailsInfoThuLabel.setForeground(gGrayColor);

        if ((aDetailsForCourse.class_schedule.class_days & UniversityW.FRIDAY.value) != 0)
    ...
    getRegisteredCoursesFromServer( int aStudentId)
    {
        ...
        {
            showStatus("Unable to get student details from the server");
            return new UniversityW.CourseDetails[0];
        }
	...
	showStatus("Not registered for any courses");
        return new UniversityW.CourseDetails[0];
    }
