...
/* Naming conventions :
   ...
   names do not use abbreviations.  e.g. :
       ...
       UniversityW::CourseSynopsisEnumerator_var
*/
...
static void get_crs_num_lst(
    UniversityW::CourseNumberList& crs_num_lst
)
{
    int done = 0;
    while (!done) {
...
static CORBA::Boolean display_course_synopsis_list(
    const UniversityW::CourseSynopsisList& crs_syn_lst,
...
static void destroy_enumerator(
    UniversityW::CourseSynopsisEnumerator_ptr p_crs_syn_enum
)
{
...
static void get_courses_synopsis(
    UniversityW::Registrar_ptr p_reg_ref,
...
)
{
    ...
    // this object
    UniversityW::CourseSynopsisEnumerator_var v_crs_syn_enum;

    // how many more matching courses are available ?
    CORBA::ULong num_remaining;

    // get the matching courses
    UniversityW::CourseSynopsisList_var v_crs_syn_lst =
...
)
{
    ...
    UniversityW::CourseDetailsList_var v_crs_det_lst =
...
{
    UniversityW::StudentDetails_var v_stu_det =
        p_reg_ref->get_student_details(stu_id);

    cout << "Your current balance is $" << v_stu_det->balance << endl;
}
...
)
{
    ...
    try {
        ...
        UniversityW::NotRegisteredList_var v_not_reg_lst =
        ...
        if (commit) {
            CORBA::Boolean report_heuristics = CORBA_FALSE;
    ...
    catch (UniversityW::DelinquentAccount&) {
        cout << "You cannot register for courses "
             << "because your account is delinquent." << endl;
        rollback(v_txn_cur_ref.in());
        // swallow the exception
    }
    catch (...) {
...
)
{
    while (1) {
        ...
        cout << "(B) Display your balance"         << endl;
...
int main(int argc, char* argv[])
{
	...
	CORBA::ORB_var v_orb = CORBA::ORB_init(argc, argv, "");
        ...
        UniversityW::StudentId stu_id =
            UniversityW::StudentId(get_long("Student id"));
        ...
        try {
            UniversityW::Registrar_var v_reg_ref =
