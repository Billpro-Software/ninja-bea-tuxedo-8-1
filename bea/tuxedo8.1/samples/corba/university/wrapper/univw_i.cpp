...
static void get_crs_det(
    Database&                   db,
    UniversityW::CourseNumber   crs_num,
    UniversityW::CourseDetails& crs_det
)
{
...

    {
        ...
        UniversityW::Days days = 0;
        if (sched.get_mon_sched()) { days |= UniversityW::MONDAY;    }
        if (sched.get_tue_sched()) { days |= UniversityW::TUESDAY;   }
        if (sched.get_wed_sched()) { days |= UniversityW::WEDNESDAY; }
        if (sched.get_thu_sched()) { days |= UniversityW::THURSDAY;  }
        if (sched.get_fri_sched()) { days |= UniversityW::FRIDAY;    }
...
static void add_not_reg(
    UniversityW::NotRegisteredList&  not_reg_lst,
    UniversityW::CourseNumber        crs_num,
    UniversityW::NotRegisteredReason reason
)
{
...
UniversityW::CourseSynopsisList*
...
)
{
    ...
    try {
        ...
        UniversityW::CourseSynopsisList_var v_crs_syn_lst =
            new UniversityW::CourseSynopsisList;
...
)
{
    ...
    try {
        ...
        UniversityW::CourseSynopsisEnumerator_var v_rest = 
            UniversityW::CourseSynopsisEnumerator::_narrow(
                rest_oref.in()
            );
        ...
        if (number_remaining == 0) {
            ...
            // a "nil" one
            v_rest->destroy();
            v_rest = UniversityW::CourseSynopsisEnumerator::_nil();
...
)
{
    ...
    try {
        ...
        UniversityW::CourseDetailsList_var v_crs_det_lst =
           new UniversityW::CourseDetailsList();
...
UniversityW::NotRegisteredList*
Registrar_i::register_for_courses(
    UniversityW::StudentId               stu_id,
    const UniversityW::CourseNumberList& crs_num_lst
)
{
    ...
    try {
        ...
        UniversityW::NotRegisteredList_var v_not_reg_lst =
            new UniversityW::NotRegisteredList();
        ...
        if (balance > max_balance) {
            ...
            throw UniversityW::DelinquentAccount();
        }
        ...
        for (CORBA::ULong i = 0; i < crs_num_lst.length(); i++) {
            ...
            UniversityW::CourseNumber crs_num = crs_num_lst[i];
    ...
    catch (UniversityW::TooManyCredits&) {
        // let it pass thru
        throw;
    }
...
UniversityW::Registrar_ptr RegistrarFactory_i::find_registrar(
)
{
    ...
    try {
        ...
        return UniversityW::Registrar::_narrow(v_reg_oref.in());
    }
    HANDLE_EX
}
