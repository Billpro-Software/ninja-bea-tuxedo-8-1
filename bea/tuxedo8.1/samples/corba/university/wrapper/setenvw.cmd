...
@rem Must match "APPDIR" in "ubb_w.nt"
@set APPDIR=C:\MY_APP_DIR

@rem Pathname of the tuxconfig file.
@rem Must match "TUXCONFIG" in "ubb_w.nt"
@set TUXCONFIG=%APPDIR%\tuxconfig

@rem Pathname of the transaction log.
@rem Must match "TLOGDEVICE" in "ubb_w.nt"
@set TLOGDEVICE=%APPDIR%\TLOG

@rem Pathname of the Tuxedo installation.
@rem Must match "TUXDIR" in "ubb_w.nt"
