...
public class UnivTApplet extends java.applet.Applet 
{

    UniversityT.CourseSynopsis[] gCourseSynopsis;
    UniversityT.CourseDetails[] gCourseDetailsFromSrvr;
    UniversityT.Registrar gRegistrarObjRef;
    UniversityT.CourseDetails[] gRegisteredCourses;
        ...
        try
        {
            ...
            if (status.value() == org.omg.Security.AuthenticationStatus._SecAuthSuccess)
            {
                ...
                try
                {
                    ...
                    UniversityT.RegistrarFactory F = UniversityT.RegistrarFactoryHelper.narrow(Of);
    ...
    void fillCourseSynopsisList()
    {
        ...
        UniversityT.CourseSynopsis[] course_synopsis =
                                getCourseSynopsisFromServer( search_string);

        UniversityT.CourseDetails[] registered_courses =
     ...
     *
     * @return UniversityT.CourseSynopsis[] An array of UniversityT.CourseSynopsis
     *                      returned by the server.
     *
     */
    UniversityT.CourseSynopsis[] getCourseSynopsisFromServer( String aCriteria)
    {

        UniversityT.CourseSynopsis[] course_synopsis_chunks = null;
        UniversityT.CourseSynopsis[] chunk_course_synopsis_from_server = null;
        final int CHUNK_SIZE = 10;
        int total_fetched = 0;
        int num_to_fetch = 0;

        org.omg.CORBA.IntHolder number_remaining = new org.omg.CORBA.IntHolder();
        UniversityT.CourseSynopsisEnumeratorHolder enumerate_the_rest =
        ...
        try
        {
            ...
            course_synopsis_chunks =
                          new UniversityT.CourseSynopsis[chunk_course_synopsis_from_server.length];
        ...
        try
        {
            ...
            while (num_to_fetch != 0)
            {
                ...
                UniversityT.CourseSynopsis[] temp_course_synopsis_chunks =
                          new UniversityT.CourseSynopsis[new_chunks_length];
                ...
                {
                    temp_course_synopsis_chunks[index] = new UniversityT.CourseSynopsis(
    ...
    void registerSynopsisList()
    {
        ...
        UniversityT.NotRegistered[] not_registered = null;
    ...
    void getCourseDetailsFromServer( int[] aSelectedCourseNumbers)
    {
        ...
        UniversityT.CourseDetails[] chunk_details_from_server = null;

        // Contains all the chunks we've gotten
        UniversityT.CourseDetails[] chunks_in_hand = null;
        ...
        for (int chunk_count = 0; chunk_count < chunks_to_get; chunk_count++)
        {
            ...
            UniversityT.CourseDetails[] temp_details_chunks =
                            new UniversityT.CourseDetails[new_chunks_length];
     ...
     */
    void fillDetailsPanel( UniversityT.CourseDetails aDetailsForCourse)
    {
        ...
        if ((aDetailsForCourse.class_schedule.class_days & UniversityT.MONDAY.value) != 0)
            DetailsInfoMonLabel.setForeground(gPurpleColor);
        else
            DetailsInfoMonLabel.setForeground(gGrayColor);

        if ((aDetailsForCourse.class_schedule.class_days & UniversityT.TUESDAY.value) != 0)
            DetailsInfoTueLabel.setForeground(gPurpleColor);
        else
            DetailsInfoTueLabel.setForeground(gGrayColor);

        if ((aDetailsForCourse.class_schedule.class_days & UniversityT.WEDNESDAY.value) != 0)
            DetailsInfoWedLabel.setForeground(gPurpleColor);
        else
            DetailsInfoWedLabel.setForeground(gGrayColor);

        if ((aDetailsForCourse.class_schedule.class_days & UniversityT.THURSDAY.value) != 0)
            DetailsInfoThuLabel.setForeground(gPurpleColor);
        else
            DetailsInfoThuLabel.setForeground(gGrayColor);

        if ((aDetailsForCourse.class_schedule.class_days & UniversityT.FRIDAY.value) != 0)
    ...
    // Get the student name and display in StudentPanel
    void getStudentName()
    {
        int student_id = Integer.parseInt (gUserId.toString());
        try
    ...
    UniversityT.CourseDetails[]
    getRegisteredCoursesFromServer( int aStudentId)
    {
        UniversityT.StudentDetails student_details = 
        ...
        return new UniversityT.CourseDetails[0];
    }
