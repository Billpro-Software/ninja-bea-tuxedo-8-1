...
static void get_crs_num_lst(
    UniversityB::CourseNumberList& crs_num_lst
)
{
    int done = 0;
    while (!done) {
...
static CORBA::Boolean display_course_synopsis_list(
    const UniversityB::CourseSynopsisList& crs_syn_lst,
...
static void destroy_enumerator(
    UniversityB::CourseSynopsisEnumerator_ptr p_crs_syn_enum
)
{
...
static void get_courses_synopsis(
    UniversityB::Registrar_ptr p_reg_ref,
...
)
{
    ...
    // this object
    UniversityB::CourseSynopsisEnumerator_var v_crs_syn_enum;
...
static UniversityB::Registrar_ptr get_registrar(
    Tobj_Bootstrap&        bootstrap
)
{
    ...
    CORBA::Object_var v_reg_fact_oref =
        v_fact_finder_ref->find_one_factory_by_id(
            UniversityB::_tc_RegistrarFactory->id()
        );

    // Narrow the registrar factory :
    UniversityB::RegistrarFactory_var v_reg_fact_ref =
...
int main(int argc, char* argv[])
{
    try {
        ...
        UniversityB::Registrar_var v_reg_ref =
