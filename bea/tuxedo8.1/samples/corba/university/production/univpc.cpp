...
static void get_crs_num_lst(
    UniversityP::CourseNumberList& crs_num_lst
)
{
    int done = 0;
    while (!done) {
...
static CORBA::Boolean display_course_synopsis_list(
    const UniversityP::CourseSynopsisList& crs_syn_lst,
...
static void destroy_enumerator(
    UniversityP::CourseSynopsisEnumerator_ptr p_crs_syn_enum
)
{
...
static void get_courses_synopsis(
    UniversityP::Registrar_ptr p_reg_ref,
...
)
{
    ...
    // this object
    UniversityP::CourseSynopsisEnumerator_var v_crs_syn_enum;
...
static UniversityP::Registrar_ptr get_registrar(
    UniversityP::StudentId stu_id,
    Tobj_Bootstrap&        bootstrap
)
{
    ...
    CORBA::Object_var v_reg_fact_oref =
        v_fact_finder_ref->find_one_factory_by_id(
            UniversityP::_tc_RegistrarFactory->id()
        );

    // Narrow the registrar factory :
    UniversityP::RegistrarFactory_var v_reg_fact_ref =
        UniversityP::RegistrarFactory::_narrow(
            v_reg_fact_oref.in()
        );

    // Return the university's registrar :
    return v_reg_fact_ref->find_registrar(stu_id);
}
...
int main(int argc, char* argv[])
{
	...
	CORBA::ORB_var v_orb = CORBA::ORB_init(argc, argv, "");
        ...
        UniversityP::StudentId stu_id =
            UniversityP::StudentId(get_long("Student id"));
        ...
        try {
            UniversityP::Registrar_var v_reg_ref =
                get_registrar(stu_id, bootstrap);
