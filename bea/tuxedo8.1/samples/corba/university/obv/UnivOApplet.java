...
public class UnivBApplet extends java.applet.Applet 
{

    UniversityB.CourseSynopsis[] gCourseSynopsis;
    UniversityB.CourseDetails[] gCourseDetailsFromSrvr;
    UniversityB.Registrar gRegistrarObjRef;
    ...
    public void init()
    {
        ...
        try
        {
            ...
            Tobj_Bootstrap bs = new Tobj_Bootstrap(orb, TuxFormatHost);
            ...
            org.omg.CORBA.Object Of =
                        Ff.find_one_factory_by_id(UniversityB.RegistrarFactoryHelper.id());
        ...
        catch(InvalidDomain e)
        {
            ...
            System.err.println("Make sure that the univb_server is running.");
            System.exit(1);
        }
    ...
    void fillCourseSynopsisList()
    {
        ...
        UniversityB.CourseSynopsis[] course_synopsis =
     ...
     *
     * @return UniversityB.CourseSynopsis[] An array of UniversityB.CourseSynopsis
     *                      returned by the server.
     *
     */
    UniversityB.CourseSynopsis[] getCourseSynopsisFromServer( String aCriteria)
    {

        UniversityB.CourseSynopsis[] course_synopsis_chunks = null;
        UniversityB.CourseSynopsis[] chunk_course_synopsis_from_server = null;
        final int CHUNK_SIZE = 10;
        int total_fetched = 0;
        int num_to_fetch = 0;

        org.omg.CORBA.IntHolder number_remaining = new org.omg.CORBA.IntHolder();
        UniversityB.CourseSynopsisEnumeratorHolder enumerate_the_rest =
                        new UniversityB.CourseSynopsisEnumeratorHolder();
        ...
        try
        {
            ...
            course_synopsis_chunks =
                          new UniversityB.CourseSynopsis[chunk_course_synopsis_from_server.length];
        ...
        try
        {
            ...
            while (num_to_fetch != 0)
            {
                ...
                UniversityB.CourseSynopsis[] temp_course_synopsis_chunks =
                          new UniversityB.CourseSynopsis[new_chunks_length];
                ...
                {
                    temp_course_synopsis_chunks[index] = new UniversityB.CourseSynopsis(
    ...
    void getCourseDetailsFromServer( int[] aSelectedCourseNumbers)
    {
        ...
        UniversityB.CourseDetails[] chunk_details_from_server = null;

        // Contains all the chunks we've gotten
        UniversityB.CourseDetails[] chunks_in_hand = null;
        ...
        for (int chunk_count = 0; chunk_count < chunks_to_get; chunk_count++)
        {
            ...
            try
            {
                // Get the chunk of details from the server
                chunk_details_from_server =
                    gRegistrarObjRef.get_courses_details( selected_course_numbers_chunk_array );
            }
            catch(org.omg.CORBA.SystemException e)
            {
            ...
            UniversityB.CourseDetails[] temp_details_chunks =
                            new UniversityB.CourseDetails[new_chunks_length];
     ...
     */
    void fillDetailsPanel( UniversityB.CourseDetails aDetailsForCourse)
    {
...
//          DetailsInfoOpenValueLabel.setText( "closed");
        ...
        if ((aDetailsForCourse.class_schedule.class_days & UniversityB.MONDAY.value) != 0)
            DetailsInfoMonLabel.setForeground(gPurpleColor);
        else
            DetailsInfoMonLabel.setForeground(gGrayColor);

        if ((aDetailsForCourse.class_schedule.class_days & UniversityB.TUESDAY.value) != 0)
            DetailsInfoTueLabel.setForeground(gPurpleColor);
        else
            DetailsInfoTueLabel.setForeground(gGrayColor);

        if ((aDetailsForCourse.class_schedule.class_days & UniversityB.WEDNESDAY.value) != 0)
            DetailsInfoWedLabel.setForeground(gPurpleColor);
        else
            DetailsInfoWedLabel.setForeground(gGrayColor);

        if ((aDetailsForCourse.class_schedule.class_days & UniversityB.THURSDAY.value) != 0)
            DetailsInfoThuLabel.setForeground(gPurpleColor);
        else
            DetailsInfoThuLabel.setForeground(gGrayColor);

        if ((aDetailsForCourse.class_schedule.class_days & UniversityB.FRIDAY.value) != 0)
