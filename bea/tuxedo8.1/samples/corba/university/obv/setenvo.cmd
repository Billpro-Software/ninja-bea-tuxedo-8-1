...
@rem Must match "APPDIR" in "ubb_b.nt"
@set APPDIR=D:\little\university\obv

@rem Pathname of the tuxconfig file.
@rem Must match "TUXCONFIG" in "ubb_b.nt"
@set TUXCONFIG=%APPDIR%\tuxconfig

@rem Pathname of the Tuxedo installation.
@rem Must match "TUXDIR" in "ubb_b.nt"
