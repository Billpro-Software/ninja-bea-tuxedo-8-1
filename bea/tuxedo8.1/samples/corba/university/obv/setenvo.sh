...
#               ORACLE_SID specific to your ORACLE installation.
	...
	AIX)	PATH=.:${JDKDIR}/jre/sh:${JDKDIR}/sh:${ORACLE_HOME}/bin:/usr/vacpp/bin:${PATH}:$TUXDIR/bin
...
export CCMPL CPPCMPL CPPINC SHLIB_PATH LD_LIBRARY_PATH
