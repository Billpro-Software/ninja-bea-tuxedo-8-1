      ...
      *
      * #ident	"@(#) samples/atmi/STOCKAPP/BUY.cbl	$Revision: 1.6 $" 
      * static	char	sccsid[] = "@(#) samples/atmi/STOCKAPP/BUY.cbl	$Revision: 1.6 $";
      *
	...
	COPY TPINFDEF.
      ...
      *****************************************************
	01  LOGMSG.
		05  FILLER	PIC X(6) VALUE  "BUY =>".
		05  LOGMSG-TEXT	PIC X(50).
	01  LOGMSG-ERR.
		05  FILLER	PIC X(10) VALUE  "BUY ERR =>".
	...
	01 CUST-HEAD.
		05  FILLER	PIC X(20).
		05  ASK-HEAD	PIC X(13) VALUE "BUY FUND FORM".
		05  FILLER	PIC X(47).
      *
