      ...
      *
      * #ident	"@(#) samples/atmi/STOCKAPP/SELLSR.cbl	$Revision: 1.5 $" 
      * static	char	sccsid[] = "@(#) samples/atmi/STOCKAPP/SELLSR.cbl	$Revision: 1.5 $";
      *
	...
	IF STATUS-1 = "0"
		MOVE "Record Exists Update It" TO LOGMSG-TEXT
	    	...
	    	PERFORM DO-UPDATE
	ELSE IF STATUS-1 = "2"
		MOVE "Record Does Not Exists" TO LOGMSG-TEXT
	    	PERFORM DO-USERLOG
		PERFORM WRITEIT-ERROR
	ELSE
	...
	CALL "USERLOG" USING LOGMSG 
      ...
      ******************************************************
       DO-UPDATE.
	IF FILE-CUST-AMOUNT GREATER CUST-AMOUNT
		PERFORM DELETE-REC
		SUBTRACT CUST-AMOUNT FROM FILE-CUST-AMOUNT
      		PERFORM WRITE-REC
	ELSE IF FILE-CUST-AMOUNT EQUAL CUST-AMOUNT
		PERFORM DELETE-REC
	ELSE
		MOVE "Not enough in FUND" TO LOGMSG-TEXT
	    	PERFORM DO-USERLOG.
