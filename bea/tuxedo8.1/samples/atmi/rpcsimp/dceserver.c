...
/* #ident	"@(#) samples/atmi/rpcsimp/dceserver.c	$Revision: 1.5 $" */

/* Modified version of $TUXDIR/lib/dceserver.c */
...
/* #define GROUP_NAME_TUX	"/.:/changecase_group"  */
 ...
 */                 
#ifndef WIN32
#define SERVER_KEYTAB		"/<DIRECTORY>/.changecase_tab"
#define SERVER_PRINCIPAL_NAME	"<PRINCIPAL>"
#endif

/* interface specification */
#define INTERFACE_SPEC		changecase_v1_0_s_ifspec
