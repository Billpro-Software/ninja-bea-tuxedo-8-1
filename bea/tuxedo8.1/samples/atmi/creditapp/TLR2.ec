...
*/
#ident	"@(#) samples/atmi/creditapp/TLR2.ec	$Revision: 1.5 $"
#ifndef NOWHAT
static	char	sccsid[] = "@(#) samples/atmi/creditapp/TLR2.ec	$Revision: 1.5 $";
#endif
...
userlog("ENTERED DEPOSIT SERVICE BANK 2 ");
...
userlog("DEPOSIT AMOUNT BANK 2 : $%.2f",amt);

userlog("ACCOUNT # BANK 2 : %d",account_id);
...
userlog("BALANCE AMOUNT BANK 2 : $%.2f",acct_bal);
...
userlog("NEW BALANCE AMOUNT BANK 2 : $%.2f",acct_bal);
...
userlog("ENTERED WITHDRAWAL SERVICE BANK 2 ");
...
userlog("WITHDRAWAL AMOUNT BANK 2 : $%.2f",amt);
...
userlog("ENTERED INQUIRY SERVICE BANK 2 ");
...
userlog("BALANCE BANK 2 : $%.2f",acct_bal);
