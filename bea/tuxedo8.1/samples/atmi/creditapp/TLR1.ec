...
*/
#ident	"@(#) samples/atmi/creditapp/TLR1.ec	$Revision: 1.5 $"
#ifndef NOWHAT
static	char	sccsid[] = "@(#) samples/atmi/creditapp/TLR1.ec	$Revision: 1.5 $";
#endif
...
userlog("ENTERED DEPOSIT SERVICE BANK 1 ");
...
userlog("DEPOSIT AMOUNT BANK 1 : $%.2f",amt);

userlog("ACCOUNT # BANK 1 : %d",account_id);
...
userlog("BALANCE AMOUNT BANK 1 : $%.2f",acct_bal);
...
userlog("NEW BALANCE AMOUNT BANK 1 : $%.2f",acct_bal);
...
userlog("ENTERED WITHDRAWAL SERVICE BANK 1 ");
...
userlog("WITHDRAWAL AMOUNT BANK 1 : $%.2f",amt);
...
userlog("ENTERED INQUIRY SERVICE BANK 1 ");
...
userlog("BALANCE BANK 1 : $%.2f",acct_bal);
