...
*/
#ident	"@(#) samples/atmi/creditapp/TLR.ec	$Revision: 1.5 $"
#ifndef NOWHAT
static	char	sccsid[] = "@(#) samples/atmi/creditapp/TLR.ec	$Revision: 1.5 $";
#endif
...
userlog("ENTERED DEPOSIT SERVICE  ");
...
userlog("ENTERED WITHDRAWAL SERVICE  ");
...
userlog("WITHDRAWAL AMOUNT  : $%.2f",amt);
...
userlog("ENTERED INQUIRY SERVICE  ");
