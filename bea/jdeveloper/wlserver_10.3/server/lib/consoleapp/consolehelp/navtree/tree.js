...
function writeNode(node, icon, highlighted, className, accessibility )
{
   ...
   if(ish)
   {
      ...
      ///document.write('<span class="anchorBoldStyle">');
   }
...
function oc(nodeId, nodeName)
{
	...
	if (theJoin.src.indexOf('minus.gif') != -1 || theJoin.src.indexOf('minusbottom.gif') != -1)   // node is closed
	{
...
{
    //alert("ocLocal = " + nodeId + "," + nodeName + "," + bottom);
  ...
  if(theJoin.src.indexOf("minus.gif") != -1 || theJoin.src.indexOf('minusbottom.gif') != -1)
