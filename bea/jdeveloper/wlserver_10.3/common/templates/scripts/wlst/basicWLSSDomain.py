...
addTemplate("C:/bea/jdeveloper/wlserver_10.3/common/templates/domains/sipserverdomain.jar")
...
writeDomain('C:/bea/jdeveloper/user_projects/domains/basicWLSSDomain')
closeTemplate()
