...
readTemplate("C:/bea/jdeveloper/wlserver_10.3/common/templates/domains/wls.jar")
addTemplate("C:/bea/jdeveloper/wlserver_10.3/common/templates/domains/replicateddomain.jar")
...
writeDomain('C:/bea/jdeveloper/user_projects/domains/replicatedDomain')
closeTemplate()
