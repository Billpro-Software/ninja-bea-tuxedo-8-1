			...
			<xsl:for-each select="start_page/main_items/item[@java = 1]">
				<xsl:if test="position() mod 2 != 0" >
					...
					<tr>
						...
						<td>
							<xsl:for-each select="../../main_items/item[@java = 1]">
