...
** lramados  06/30/05 - Store the PortalCombinedMO in target instance without
...
** --------------------------------------------------------------------------->
*/
public class PortalPackageInTargetListener extends PortalTransferListenerBase
{
    //======================================================================
    // Constructor.
    //======================================================================
    ...
    */
    public PortalPackageInTargetListener()
    {
    }
    ...
    */
                              ...
                              TransferUnitList transferUnitList)
    {
        ...
        // transferUnitList is stored in member variable so that documents
        // in the transferUnitList can be excluded in
        ...
        try
        {
            XMLDocument newDoc = createPortalCombinedMO(
                                         mTransferUnitsNotToProcess,
                                         sourceSession);
