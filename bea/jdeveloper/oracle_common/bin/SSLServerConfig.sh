#!/bin/sh
#
# SSLServerConfig.sh   version: 11.1.1.4.0
#
...
#
echo ""
echo "Server SSL Automation Script: Release 11.1.1.4.0 - Production"
echo "Copyright (c) 2010 Oracle.  All rights reserved."
echo " "


export OraComBin=$ORACLE_HOME/../oracle_common/bin
export OraBin=$ORACLE_HOME/bin
export caRoot=$ORACLE_HOME/rootCA
export logDir=$caRoot/log
export timeStamp=`date +%Y%m%d%H%M%S`
export wltDir=$caRoot/wallet
export jksDir=$caRoot/keystores
if [ "$OS" = "Windows_NT" ]
then
export OraPKI=$OraComBin/orapki.bat
export hostName=`hostname`
else
export OraPKI=$OraComBin/orapki
...
if [ "X$JAVA_HOME" = "X" ]
then 
 export JAVA_HOME=$ORACLE_HOME/../jdk160_21
 if [ ! -e  $JAVA_HOME ]
 then 
