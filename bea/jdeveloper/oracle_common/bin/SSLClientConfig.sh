#!/bin/sh
#
# SSLClientConfig.sh   version: 11.1.1.4.0
#
...
#
echo ""
echo "SSL Automation Script: Release 11.1.1.4.0 - Production"
...
export trustStoreDir=$caRoot/keystores
export trustStoreName="trust.jks"
