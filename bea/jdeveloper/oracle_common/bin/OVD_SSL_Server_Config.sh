#!/bin/sh
#
# OVD_SSL_Server_Config.sh   version: 11.1.1.4.0
#
...
#
#echo ""
#echo "OVD Server SSL Automation Script: Release 11.1.1.4.0 - Production"
...
## ovdssl-check.py
##--------------------------------------------------------------------
echo "connect('$webadmin','$webpass','t3://$HOSTNAME:$webadminport')
custom()
