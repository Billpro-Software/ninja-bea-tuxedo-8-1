--
-- $Header: entsec_ldap/java/src/oracle/security/audit/rcu/scripts/auditreports.pls /st_entsec_11.1.1.4.0/1 2010/08/11 15:44:55 skalyana Exp $
--
-- auditreports.pls
--
...
--
--   MODIFIED   (MM/DD/YY)
--   skalyana    08/10/10 - XbranchMerge skalyana_bug-9816072 from main
...
-- Compose ORDER BY Clause --
        ...
        if (p_sort_by is not null and p_order_by is not null) then
