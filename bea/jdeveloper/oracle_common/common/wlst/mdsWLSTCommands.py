...
# @applicationVersion
# @server
def deleteMetadata(application, server, docs, restrictCustTo=None, excludeAllCust='false', excludeBaseDocs='false', excludeExtendedMetadata='false', cancelOnException='true', applicationVersion=None):
	operationName = 'deleteMetadata'
	required(application, 'application')
	required(server,'server')
	required(docs,'docs')
	params = jarray.array([convertStringToArray(docs, 'docs', operationName), convertStringToArray(restrictCustTo, 'restrictCustTo', operationName), getBooleanFromArg(excludeAllCust), getBooleanFromArg(excludeBaseDocs), getBooleanFromArg(excludeExtendedMetadata), getBooleanFromArg(cancelOnException)],java.lang.Object)
	signature = jarray.array(['[Ljava.lang.String;','[Ljava.lang.String;','boolean','boolean','boolean','boolean'],java.lang.String)
	paramNames = jarray.array(['docs', 'restrictCustTo', 'excludeAllCust', 'excludeBaseDocs', 'excludeExtendedMetadata', 'cancelOnException'],java.lang.String)
...
# @server
# @remote
def exportSandboxMetadata(application, server, toArchive, sandboxName, restrictCustTo='%', applicationVersion=None, remote='false'):
	operationName = 'exportSandboxMetadata'
	required(application,'application')
	required(server,'server')
	required(toArchive,'toArchive')
	required(sandboxName,'sandboxName')
        params=jarray.array([toArchive, sandboxName, convertStringToArray(restrictCustTo, 'restrictCustTo', operationName)], java.lang.Object)
        signature=jarray.array(['java.lang.String','java.lang.String','[Ljava.lang.String;'], java.lang.String)
        paramNames = jarray.array(['toArchive', 'sandboxName', 'restrictCustTo'],java.lang.String)
	retValue = None
...
# @server
# @remote
def importSandboxMetadata(application, server, fromArchive, forceSBCreation='false', useExistingSandbox='false', sandboxName=None, applicationVersion=None, remote='false'):
	...
	if getBooleanFromArg(useExistingSandbox) == Boolean('true') and sandboxName != None:
		params=jarray.array([fromArchive, sandboxName], java.lang.Object)
		signature=jarray.array(['java.lang.String', 'java.lang.String'], java.lang.String)
		paramNames = jarray.array(['fromArchive', 'sandboxName'],java.lang.String)
		transMgrOperationName = 'updateSandboxMetadata'
	else:
		params=jarray.array([fromArchive, getBooleanFromArg(forceSBCreation)], java.lang.Object)
		signature=jarray.array(['java.lang.String', 'boolean'], java.lang.String)
		paramNames = jarray.array(['fromArchive', 'forceSBCreation'],java.lang.String)
        retValue = None
        if getBooleanFromArg(remote) == Boolean('true'):
...
# @server
# @remote
def exportMetadata(application, server, toLocation, docs='/**', restrictCustTo=None, excludeCustFor=None, excludeAllCust='false', excludeBaseDocs='false', excludeExtendedMetadata='false', excludeSeededDocs='false', fromLabel=None, toLabel=None, applicationVersion=None, remote='false'):
	operationName = 'exportMetadata'
	required(application,'application')
	required(server,'server')
	required(toLocation,'toLocation')
        params = jarray.array([toLocation,getBooleanFromArg('false'), convertStringToArray(docs, 'docs', operationName), convertStringToArray(restrictCustTo, 'restrictCustTo', operationName), convertStringToArray(excludeCustFor, 'excludeCustFor', operationName), getBooleanFromArg(excludeAllCust), getBooleanFromArg(excludeBaseDocs), getBooleanFromArg(excludeExtendedMetadata), getBooleanFromArg(excludeSeededDocs), fromLabel, toLabel], java.lang.Object)
        signature = jarray.array(['java.lang.String', 'boolean', '[Ljava.lang.String;', '[Ljava.lang.String;', '[Ljava.lang.String;', 'boolean', 'boolean', 'boolean', 'boolean', 'java.lang.String', 'java.lang.String'], java.lang.String)
        paramNames = jarray.array(['toLocation', 'createSubDir', 'docs', 'restrictCustTo', 'excludeCustFor', 'excludeAllCust', 'excludeBaseDocs', 'excludeExtendedMetadata', 'excludeSeededDocs', 'fromLabel', 'toLabel'], java.lang.String)
	retValue = None
        if getBooleanFromArg(remote) == Boolean('true'):
                retValue = executeMetadataTransferManagerOperation(application, applicationVersion, server, operationName, params, signature, paramNames)
        else:       
...
# @server
# @remote
def importMetadata(application, server, fromLocation, docs='/**', restrictCustTo=None, excludeAllCust='false', excludeBaseDocs='false', excludeExtendedMetadata='false', excludeUnmodifiedDocs='false', cancelOnException='true', applicationVersion=None, remote='false'):
	operationName = 'importMetadata'
	required(application,'application')
	required(server,'server')
	required(fromLocation,'fromLocation')
	params=jarray.array([fromLocation, convertStringToArray(docs, 'docs', operationName), convertStringToArray(restrictCustTo, 'restrictCustTo', operationName), getBooleanFromArg(excludeAllCust), getBooleanFromArg(excludeBaseDocs), getBooleanFromArg(excludeExtendedMetadata), getBooleanFromArg(excludeUnmodifiedDocs), getBooleanFromArg(cancelOnException)], java.lang.Object)
	signature=jarray.array(['java.lang.String', '[Ljava.lang.String;','[Ljava.lang.String;','boolean','boolean','boolean','boolean','boolean'], java.lang.String)
	paramNames = jarray.array(['fromLocation', 'docs', 'restrictCustTo', 'excludeAllCust', 'excludeBaseDocs', 'excludeExtendedMetadata', 'excludeUnmodifiedDocs', 'cancelOnException'],java.lang.String)
        retValue = None
        if getBooleanFromArg(remote) == Boolean('true'):
                retValue = executeMetadataTransferManagerOperation(application, applicationVersion, server, operationName, params, signature, paramNames)
        else:
...
# @applicationVersion
# @server
def createMetadataLabel(application, server, name, applicationVersion=None):
	required(application,'application')
	required(server,'server')
	required(name,'name')
...
# @applicationVersion
# @server
def deleteMetadataLabel(application, server, name, applicationVersion=None):
	required(application,'application')
	required(server,'server')
	required(name,'name')
	params= jarray.array([name],java.lang.Object)
...
# @applicationVersion
# @server
def listMetadataLabels(application, server, applicationVersion=None):
	required(application,'application')
	required(server,'server')
	params= jarray.zeros(0,java.lang.Void)
	signature=jarray.array([],java.lang.String)
	paramNames = jarray.array([],java.lang.String)
...
# @applicationVersion
# @server
def promoteMetadataLabel(application, server, name, applicationVersion=None):
	required(application,'application')
	required(server,'server')
	required(name,'name')
	params= jarray.array([name],java.lang.Object)
...
def purgeMetadataLabels(repository, partition, namePattern=None, olderThanInMin='525600', infoOnly='false'):
        required(repository,'repository')
        required(partition,'partition')
        params= jarray.array([repository, partition, namePattern, java.lang.Long(olderThanInMin)], java.lang.Object)
        signature=jarray.array(['java.lang.String', 'java.lang.String', 'java.lang.String', 'long'], java.lang.String)
        paramNames = jarray.array(['repository', 'partition', 'namePattern', 'olderThanInMin'], java.lang.String)
...
def getMDSAppRuntimeMBean(application, applicationVersion, server, mbeanOperation):
	...
	if bean is None:
		raise UserWarning, ScriptMessageHelper.getMessage("MDS_APP_MBEAN_NOT_FOUND", application, mbeanOperation)
	elif bean.size() > 1:
		raise UserWarning, ScriptMessageHelper.getMessage("MULTIPLE_APP_MBEAN_FOUND", application, mbeanOperation)
	else:
