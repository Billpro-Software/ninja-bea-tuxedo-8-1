@REM $Header: askernel/dist/oracle.jrf.askernel/common/bin/setNMProps.cmd /askernel_11.1.1.4.0/1 2010/11/08 08:30:11 xidu Exp $
@REM
@REM setNMProps.cmd
@REM
@REM Copyright (c) 2008, 2011 Oracle and/or its affiliates.All rights reserved. 
@REM
@REM    NAME
